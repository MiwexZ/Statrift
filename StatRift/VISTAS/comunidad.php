        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8">
                ...
                <div class="alert alert-dark border-gold text-center mb-5" data-aos="fade-up">
                    ...
                    Para poder crear una publicación o comentar necesitas <a href="/statrift/VISTAS/login.php" class="text-gold fw-bold">iniciar sesión</a>.
                </div>
                <?php endif; ?>
    ...
    <script>
        ...
        if (formPub) {
            formPub.addEventListener('submit', function(e) {
                ...
                fetch('/statrift/CONTROLADORES/api_comunidad.php', {
                    method: 'POST',
                    body: formData
                })
                .then(res => res.json())
