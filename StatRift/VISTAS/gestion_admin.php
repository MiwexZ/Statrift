...
if (!isset($_SESSION['nick']) || $_SESSION['nick'] !== 'admin') {
    header("Location: /statrift/index.php");
    exit;
}
        ...
        <div class='container-fluid px-4'>
            ...
            <div class='collapse navbar-collapse'>
                <ul class='navbar-nav ms-auto'>
                    <li class='nav-item'>
                        <a class='nav-link' href='/statrift/index.php'><i class='fa-solid fa-house me-1'></i> Volver a la Web</a>
                    </li>
                    <li class='nav-item'>
                        <a class='nav-link text-danger' href='/statrift/CONTROLADORES/logout.php'><i class='fa-solid fa-power-off me-1'></i> Cerrar sesión</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <script>
        ...
        document.querySelectorAll('.btn-delete-post').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                fetch('/statrift/CONTROLADORES/api_admin.php', { method: 'POST', body: formData })
