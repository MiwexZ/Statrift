...
$id = intval($_GET['id'] ?? 0);
if ($id <= 0) { header("Location: /statrift/VISTAS/campeones.php"); exit; }

$modelo  = new modelo_build();
$campeon = $modelo->get_campeon($id);
if (!$campeon) { header("Location: /statrift/VISTAS/campeones.php"); exit; }
...
if ($build) {
    ...
    // Intentamos la query completa con las columnas nuevas
    $stmt = $db->prepare(
        "SELECT o.nombre,
                IF(LOCATE('riot_id', GROUP_CONCAT(COLUMN_NAME)) > 0, o.riot_id, NULL) as riot_id,
                bo.orden
...
<body>
    ...
    <div class="container pb-5">
        ...
        <div class="text-center mt-4">
            <a href="/statrift/VISTAS/campeones.php" class="btn btn-outline-light px-4 me-2">
