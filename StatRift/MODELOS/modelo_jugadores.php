...
class modelo_jugadores
{
                        ...
                        <div class='login-box bg-glass p-5 rounded-4' style='width:100%;max-width:420px;'>
                            ...
                            <form method='POST' action='../CONTROLADORES/iniciar_sesion.php'>
                                ...
                                <p class='text-center mt-3 mb-0'>
                                    <a class='text-muted small' href='/statrift/index.php'>
    ...
    {
        // Bypass especial para el admin (ya que no existe en la BD tras limpiar el hardcodeado)
        ...
        if ($resultado->num_rows > 0) {
            ...
            if (password_verify($pass, $fila['pass']) || $fila['pass'] === $pass) {
                if ($fila['activo'] == 1) {
                    session_start();
                    $_SESSION['nick'] = $nick;
